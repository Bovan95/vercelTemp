...
const contracts: Contract[] = [
  ...
  {
    contract_number: 'NL-2024-002',
    license_plate: 'EF-456-GH',
    phone: '+31698765432',
    customer: { first_name: 'Sophie', last_name: 'Bakker', email: 'sophie.bakker@example.nl', phone: '+31698765432' },
    vehicle: { make: 'BMW', model: 'X3 xDrive30e', year: 2023, license_plate: 'EF-456-GH' },
